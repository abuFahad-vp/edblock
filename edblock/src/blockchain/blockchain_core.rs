...
pub struct Certificate {
    ...
    pub stud_pub_key: String,
    pub stud_wallet_addr: String,
    pub uni_wallet_addr: String,
    pub stud_sign: String,
    pub uni_pub_key: String,
    pub status: String,
    pub uni_sign: String,
}
...
impl Chain {
    ...
    async fn start_chain(node: Node) -> Chain {
        let mut init_page = menu_builder::MenuBuilder::new();
    ...
    // adding peer
        ...
        let mut peer_page = menu_builder::MenuBuilder::new();
   ...
   async fn download_and_extract(addr: String) -> (DB, u32) {
    ...
    pub fn new_transaction(&mut self, certificate: Certificate) -> bool {
...
impl fmt::Display for Certificate {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            ...
            Status: {}\n
            ",
            self.course_id, self.course_name, self.stud_wallet_addr, self.uni_wallet_addr, self.status
        )
    }
}